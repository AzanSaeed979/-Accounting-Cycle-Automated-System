...
import { Table, Card, Select, Row, Col, Spin, Alert, Space, Button, DatePicker, message, Tag, Modal, Collapse, Divider, Statistic } from 'antd';
  ...
  const fetchTrialBalance = async () => {
    ...
    try {
      const [tbRes, jeRes] = await Promise.all([
        api.get('/api/accounting-cycle/trial-balance', {
          params: {
    ...
    <div style={{ padding: '24px' }}>
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col span={24}>
          ...
          <span style={{ color: '#666' }}>Verify that debits equal credits</span>
        </Col>
      </Row>
          ...
          <>
            ...
            {getUnbalancedEntries().length > 0 ? (
              ...
              <Alert
                ...
                description="All individual journal entries are balanced, but the trial balance is still unbalanced. This might be due to opening balances or data inconsistency."
                type="warning"
                showIcon
                style={{ marginBottom: '16px' }}
              />
            ...
            <div style={{ padding: '16px', background: '#f0f7ff', borderRadius: '8px' }}>
              ...
              <ol style={{ marginLeft: '20px' }}>
                ...
                <li style={{ marginBottom: '8px' }}>
                  <strong>Check Opening Balances:</strong> Go to Chart of Accounts and verify opening balances are correct.
                </li>
                <li style={{ marginBottom: '8px' }}>
