      ...
      <body>
        ...
        <table>
          ...
          <tbody>
            ...
            `).join('')}
            ${balanceSheet.assets.length === 0 ? '<tr><td colspan="2" style="text-align:center;color:#999;">No asset accounts</td></tr>' : ''}
            <tr class="total-row">
            ...
            `).join('')}
            ${balanceSheet.liabilities.length === 0 ? '<tr><td colspan="2" style="text-align:center;color:#999;">No liability accounts</td></tr>' : ''}
            <tr class="total-row">
    ...
    <div style={{ padding: '24px' }}>
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        <Col span={24}>
          ...
          <span style={{ color: '#666' }}>Assets, Liabilities, and Equity</span>
        </Col>
      </Row>
      ...
      <Card style={{ marginBottom: '24px', borderRadius: '8px' }}>
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12} md={4}>
            <Space>
              <Button icon={<ReloadOutlined />} onClick={fetchBalanceSheet}>
                Refresh
              </Button>
              <Button
                type="primary"
            ...
            <Spin spinning={loadingBS}>
              <div style={{ marginBottom: '24px' }}>
                ...
                <Table
                  ...
                  pagination={false}
                  size="small"
                  locale={{ emptyText: 'No asset accounts found' }}
                  summary={() => (
                    <Table.Summary>
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <Table
                  ...
                  pagination={false}
                  size="small"
                  locale={{ emptyText: 'No liability accounts found' }}
                  summary={() => (
                    <Table.Summary>
                      <Table.Summary.Row style={{ background: '#f0f7ff', fontWeight: 'bold' }}>
